module V1
  class AddressesController < ApplicationController
    ...
    #   if Client.find(params[:client_id]) && address.save
    ...
    #   if Client.find(params[:client_id]) && address.update(update_params)
    #     render json: address, only: [:id, :address_line_1, :address_line_2, :postal_code, :city, :country], include:
    ...
    # end
    # TODO fix object nesting, example: https://www.digitalocean.com/community/tutorials/how-to-create-nested-resources-for-a-ruby-on-rails-application
