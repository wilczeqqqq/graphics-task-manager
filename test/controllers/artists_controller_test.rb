...
# todo fix tests for artists, tests are failing because of changes in authentication method - no actual 'password' field, but it is required by model validator to be filled
